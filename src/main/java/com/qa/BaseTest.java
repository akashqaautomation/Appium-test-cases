...
//		server = getAppiumService(); // -> If using Mac, uncomment this statement and comment below statement
	...
	public AppiumDriverLocalService getAppiumService() {
		...
		environment.put("PATH", "%ANDROID_HOME%\\platform-tools:%ANDROID_HOME%\\build-tools:%ANDROID_HOME%\\tools:C:\\Users\\akash\\AppData\\Roaming\\npm" + System.getenv("PATH"));
		environment.put("ANDROID_HOME", "/Users/akash/AppData/Local/Android/Sdk");
...
//				desiredCapabilities.setCapability("unlockKey", "620063");
			...
			case "browserstack":
		    	...
		    	caps.setCapability("browserstack.user", props.getProperty("user"));
		    	caps.setCapability("browserstack.key", props.getProperty("key"));
		    	
		    	// Set URL of the application under test
		    	caps.setCapability("app", props.getProperty("appUrl"));
		    	
		    	// Specify device and os_version for testing
		        caps.setCapability("device", props.getProperty("device"));
		        caps.setCapability("os_version", props.getProperty("os_version"));
